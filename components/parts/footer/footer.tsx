        ...
        <div className="py-12 border-t border-white/10 bg-black">
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-4 gap-8 mb-8">
                    <div>
                        <h3 className="text-xl font-bold mb-4 text-[#ff5757]">Goheza</h3>
                        <p className="text-gray-400">Redefining what's possible with influence.</p>
                    </div>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <div className='flex space-x-4'>
                        <Link href={"/"} className=' block rounded-full  p-2 bg-white '>
                            <Twitter />
                        </Link>
                          <Link href={"/"} className=' block rounded-full  p-2 bg-white '>
                           <Youtube />
