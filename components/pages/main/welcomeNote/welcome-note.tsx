    ...
    return (
        <div className="flex flex-col items-center mb-12 mt-2 px-4 md:px-8 lg:px-16 h-auto">
            <div className="mt-1 flex flex-col items-center space-y-4 text-center">
                ...
                <h1 className="text-xl sm:text-4xl md:text-4xl lg:text-6xl font-bold tracking-tight leading-tight mt-3">
                    Earn Money <span className='text-[#ff5757]'>Creating</span> Content Online
                    <br></br>
                ...
                <p className="font-medium text-base sm:text-lg md:text-xl lg:text-2xl text-black max-w-2xl mx-auto mt-2">
